...
declare global {
  ...
  const STRING_URL_REGEX: typeof import('./utils/constant')['STRING_URL_REGEX']
  ...
  const insertText: typeof import('./hooks/useScriptApi')['insertText']
  ...
  const useOPRecord: typeof import('./hooks/useOPRecord')['useOPRecord']
